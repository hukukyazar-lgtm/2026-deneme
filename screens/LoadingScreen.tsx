...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({ backgroundUrl, onFinished }) => {
  ...
  const bgImage = backgroundUrl || "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?auto=format&fit=crop&q=80&w=1080&h=1920";

  return (
    <div className="absolute inset-0 bg-[#020617] flex flex-col items-center justify-center p-8 overflow-hidden">
      {/* Enhanced Background Prominence */}
      <img 
        src={bgImage} 
        className="absolute inset-0 w-full h-full object-cover opacity-65 brightness-[0.6] contrast-[1.2] scale-105 transition-all duration-1000"
        alt=""
        aria-hidden="true"
      />
      ...
      <div className={`z-20 text-center mb-16 relative transition-all duration-1000 ${isAssembling ? 'opacity-0 scale-50 blur-lg' : 'opacity-100'}`}>
        <h1 className="text-6xl font-[900] tracking-[0.4em] text-white drop-shadow-[0_0_35px_rgba(56,189,248,0.7)]">
          LUMINA
        </h1>
      </div>
